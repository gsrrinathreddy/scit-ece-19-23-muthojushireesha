  ...
  return (
    <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper', p: 3}}>
      ...
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="Sree chaitanya technological science College " src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSPcHLQr7yXRS3xTzz-fDmcbo_3WbimLnvW5-w8r5IJQ&s" />
        </ListItemAvatar>
        <ListItemText
          primary="Sree chaitanya technological science College "
          secondary={
            <React.Fragment>
              <Typography
                sx={{ display: 'inline' }}
      ...
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="TS Model School" src="https://55knots.com.au/wp-content/uploads/2021/01/Zanj-Avatar-scaled.jpg" />
        </ListItemAvatar>
        <ListItemText
          primary="TS Model School"
          secondary={
            <React.Fragment>
              <Typography
                sx={{ display: 'inline' }}
